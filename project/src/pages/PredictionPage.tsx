...
// export default PredictionPage; //This is Original
...
// Define the types for your heart conditions and prediction results
type HeartCondition = {
    name: string;
    description: string;
    causes: string[];
...
type APIPredictionResult = {
    status: 'normal' | 'abnormal' | 'uncertain';
    confidence: number;
    condition?: string; // This will come from your backend, e.g., "Atrial Fibrillation"
...
const heartConditions: Record<string, HeartCondition> = {
    'Arrhythmia': { // Ensure this key matches what your backend might send
        name: 'Cardiac Arrhythmia',
        description: 'An irregular heartbeat or abnormal heart rhythm where the heart beats too fast, too slow, or irregularly.',
        causes: [
            'Heart disease or damage',
    ...
    'Myocardial Infarction': { // Ensure this key matches what your backend might send
        name: 'Myocardial Infarction (Heart Attack)',
        description: 'A serious condition where blood flow to part of the heart muscle is blocked, causing tissue damage.',
        causes: [
            'Coronary artery disease',
    ...
    'Atrial Fibrillation': { // Ensure this key matches what your backend might send
        name: 'Atrial Fibrillation (AFib)',
        description: 'A common type of irregular heartbeat where the upper chambers of the heart beat chaotically and irregularly.',
        causes: [
            'High blood pressure',
